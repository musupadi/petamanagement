  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="<?php base_url() ?>">PETA</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Morris.js charts -->
<script src="<?php echo base_url();?>asset/AdminLTE-2.4.18/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo base_url();?>asset/AdminLTE-2.4.18/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
