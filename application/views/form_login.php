...
<body class="hold-transition login-page">
  ...
  <!-- /.login-logo -->
    <div class="login-box-body">
      <div class="box-header with-border">
        <div class="login-logo">
            <img class="profile-user-img img-responsive" src="<?php echo base_url()?>img/default.png" alt="User profile picture">
        </div>
    </div>
    <div class="login-box-body">
      <div class="box-header with-border">
    ...
    <p class="text-light-blue text-center">Copyright PETA @ 2024 All Right Reserved</p>
